...
<script>
      ...
      var Temp = [];
      var RecipeTitle = "<?php echo $Recipe_Title; ?>";

      $.ajax({
        url: '../Script/RecipeSearch.php',
        type: 'GET',
    ...
    function Input() 
        {
          var Recipe_Title = document.RecipeSearch.Recipe_Title.value;
          location.href = "../RecipeSearch.php?Recipe_Title="+Community_Title;
        }
  </script>
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-d9ff"><div class="u-clearfix u-sheet u-valign-bottom-xs u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-white u-section-1" id="carousel_2df3">
      ...
      <a class="u-active-none u-align-right-xs u-border-none u-btn u-button-style u-white u-hover-none u-text-body-alt-color u-btn-1" disable>글쓰기</a>
      <div class="u-form u-form-1">
        <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="RecipeSearch" style="padding: 10px;">
          <div class="u-form-group">
            <input type="text" placeholder="검색하기" id="name-e801" name="Recipe_Title" class="u-border-4 u-border-custom-color-1 u-input u-input-rectangle u-white" required="required" style="width:85%; float:left;">
