    ...
    <section class="u-align-center u-clearfix u-white u-section-1" id="carousel_2df3">
        ...
        <table class="u-table-entity">
          ...
          <tbody class="u-table-body">
            <tr style="height: 46px;">
              <td class="u-border-4 u-border-custom-color-1 u-table-cell"><?=$Recipe_Title?></td>
              <td class="u-align-center-xs u-border-4 u-border-custom-color-1 u-table-cell"><?=$Recipe_Like?></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="u-border-4 u-border-custom-color-1 u-container-style u-group u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <p class="u-text u-text-default-xs u-text-1"><?=$Recipe_Data?></p>
        </div>
      </div>
      <a href="../Script/RecipeLike.php?Num=<?=$Num?>" class="u-active-custom-color-2 u-border-none u-btn u-button-style u-custom-color-1 u-hover-custom-color-2 u-text-white u-btn-1">좋아요</a>
      <a href="../RecipeList.html" class="u-active-custom-color-2 u-border-none u-btn u-button-style u-custom-color-1 u-hover-custom-color-2 u-text-white u-btn-2">목록으로<br>
      </a>
    </section>
</body></html>